...
Images are preprocessed using ImageMagick and a few bash scripts. Generated images are source-controlled (git) so there should be no need to do it unless you are adding more images. That means, you should be able to use java only.
